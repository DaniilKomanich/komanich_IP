...
if __name__ == '__main__':
    ...
    print("Ключи Алисы - публичный: " + str(a_public) + "; приватный: " + str(a_private))

    b_public = get_prime_number()
    b_private = get_prime_number()
    print("Ключи Боба - публичный: " + str(b_public) + "; приватный: " + str(b_private))

    e_public = get_prime_number()
    e_private = get_prime_number()
    print("Ключи Ева - публичный: " + str(e_public) + "; приватный: " + str(e_private))

    Alice = CHAT(a_public, b_public, a_private)
    Bob = CHAT(a_public, b_public, b_private)
    Eve = CHAT(a_public, b_public, e_private)
